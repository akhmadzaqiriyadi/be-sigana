...
export const BB_U_GIRL = {
  minus3SD: [2.0, 2.7, 3.4, 4.0, 4.4, 4.8, 5.1, 5.3, 5.6, 5.8, 5.9, 6.1, 6.3, 6.4, 6.6, 6.7, 6.9, 7.0, 7.2, 7.3, 7.5, 7.6, 7.8, 7.9, 8.1],
...
export const TB_U_BOY = {
  minus3SD: [44.2, 48.9, 52.4, 55.6, 58.7, 61.7, 63.3, 64.8, 66.2, 67.5, 68.7, 69.9, 71.0, 72.1, 73.1, 74.1, 75.0, 76.0, 76.9, 77.7, 78.6, 79.4, 80.2, 81.0, 81.7],
  minus2SD: [46.1, 50.8, 54.4, 57.6, 60.0, 61.9, 63.6, 65.1, 66.5, 67.9, 69.2, 70.4, 71.5, 72.6, 73.7, 74.7, 75.6, 76.5, 77.4, 78.2, 79.1, 79.9, 80.7, 81.6, 82.3]
};

// TB/U GIRLS
export const TB_U_GIRL = {
  minus3SD: [43.6, 47.8, 51.0, 54.1, 57.0, 59.9, 61.2, 62.7, 64.0, 65.3, 66.5, 67.7, 68.9, 70.0, 71.0, 72.0, 73.0, 74.0, 74.9, 75.8, 76.7, 77.5, 78.4, 79.2, 80.0],
  minus2SD: [45.4, 49.8, 53.2, 56.4, 59.0, 60.9, 62.5, 64.1, 65.5, 66.9, 68.2, 69.5, 70.7, 71.8, 72.9, 73.9, 74.9, 75.8, 76.8, 77.7, 78.6, 79.4, 80.3, 81.1, 82.0]
};
